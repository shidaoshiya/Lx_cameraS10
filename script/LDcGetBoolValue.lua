...
result1=DcGetBoolValue(LxDeviceInfo.handle,cmd,value);
if result1 ~= 0 then
    print("LDcGetBoolValue.lua run failed.")
    print("LDcGetBoolValue run result: "..result1)
else
    print("LDcGetBoolValue.lua run success.")
end
print("The Value is:"..tostring(value))