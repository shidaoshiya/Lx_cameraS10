...
result1=DcSpecialControl(LxDeviceInfo.handle,command,value)
if result1 ~= 0 then
    print("LDcSpecialControl() run failed.")
    print("DcSpecialControl result: "..result1)
else
    print("LDcSpecialControl() run success.")
end
print("value: "..value)
