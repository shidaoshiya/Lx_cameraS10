...
result1=DcUnregisterCameraStatusCallback(LxDeviceInfo.handle)
if result1 ~= 0 then
    print("LDcUnregisterCameraStatusCallback.lua run failed")
    print("DcOpenDevice result: "..result1)
else
    print("LDcUnregisterCameraStatusCallback.lua run success")
end